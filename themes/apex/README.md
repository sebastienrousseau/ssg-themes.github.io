...
Executive portfolio theme for consultants, directors and advisors. Five page types, no build toolchain, and every accessibility claim checked by a gate in CI.

![Apex screenshot](images/screenshot.png)

- **Demo:** <https://ssg-themes.github.io/apex/>
- **Licence:** MIT
- **Requires:** ssg 0.0.49+
...
| Layout | Used for |
| --- | --- |
| `index` | Home page: hero, metric grid, prose |
| `projects` | Case-study index |
| `frameworks` | Method and conventions |
...
| `base_path` | Root-relative prefix for internal links, e.g. `/apex/` |
